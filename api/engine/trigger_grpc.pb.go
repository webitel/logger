...
func (c *triggerServiceClient) SearchTrigger(ctx context.Context, in *SearchTriggerRequest, opts ...grpc.CallOption) (*ListTrigger, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListTrigger)
	err := c.cc.Invoke(ctx, TriggerService_SearchTrigger_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *triggerServiceClient) ReadTrigger(ctx context.Context, in *ReadTriggerRequest, opts ...grpc.CallOption) (*Trigger, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Trigger)
	err := c.cc.Invoke(ctx, TriggerService_ReadTrigger_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *triggerServiceClient) PatchTrigger(ctx context.Context, in *PatchTriggerRequest, opts ...grpc.CallOption) (*Trigger, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Trigger)
	err := c.cc.Invoke(ctx, TriggerService_PatchTrigger_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *triggerServiceClient) CreateTriggerJob(ctx context.Context, in *CreateTriggerJobRequest, opts ...grpc.CallOption) (*TriggerJob, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TriggerJob)
	err := c.cc.Invoke(ctx, TriggerService_CreateTriggerJob_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *triggerServiceClient) SearchTriggerJob(ctx context.Context, in *SearchTriggerJobRequest, opts ...grpc.CallOption) (*ListTriggerJob, error) {
	...
	err := c.cc.Invoke(ctx, TriggerService_SearchTriggerJob_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
