...
func (c *mediaFileServiceClient) SearchMediaFile(ctx context.Context, in *SearchMediaFileRequest, opts ...grpc.CallOption) (*ListMedia, error) {
	...
	out := new(ListMedia)
	err := c.cc.Invoke(ctx, MediaFileService_SearchMediaFile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mediaFileServiceClient) ReadMediaFile(ctx context.Context, in *ReadMediaFileRequest, opts ...grpc.CallOption) (*MediaFile, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MediaFile)
	err := c.cc.Invoke(ctx, MediaFileService_ReadMediaFile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mediaFileServiceClient) DeleteMediaFile(ctx context.Context, in *DeleteMediaFileRequest, opts ...grpc.CallOption) (*MediaFile, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MediaFile)
	err := c.cc.Invoke(ctx, MediaFileService_DeleteMediaFile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mediaFileServiceClient) ReadMediaFileNA(ctx context.Context, in *ReadMediaFileRequest, opts ...grpc.CallOption) (*MediaFile, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MediaFile)
	err := c.cc.Invoke(ctx, MediaFileService_ReadMediaFileNA_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedMediaFileServiceServer must be embedded to have
...
func (UnimplementedMediaFileServiceServer) testEmbeddedByValue()                          {}
...
func RegisterMediaFileServiceServer(s grpc.ServiceRegistrar, srv MediaFileServiceServer) {
	// If the following call pancis, it indicates UnimplementedMediaFileServiceServer was
