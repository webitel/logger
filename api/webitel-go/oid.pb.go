...
const file_oid_proto_rawDesc = "" +
	"\n" +
	"\toid.proto\x12\x03api\".\n" +
	"\bObjectId\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04nameBS\n" +
	"\acom.apiB\bOidProtoP\x01Z\x12webitel.go/api;api\xa2\x02\x03AXX\xaa\x02\x03Api\xca\x02\x03Api\xe2\x02\x0fApi\\GPBMetadata\xea\x02\x03Apib\x06proto3"

var (
	file_oid_proto_rawDescOnce sync.Once
	file_oid_proto_rawDescData []byte
)

func file_oid_proto_rawDescGZIP() []byte {
	file_oid_proto_rawDescOnce.Do(func() {
		file_oid_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_oid_proto_rawDesc), len(file_oid_proto_rawDesc)))
	})
...
func file_oid_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_oid_proto_rawDesc), len(file_oid_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
