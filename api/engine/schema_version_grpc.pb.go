...
func (c *schemaVersionServiceClient) SearchSchemaVersion(ctx context.Context, in *SearchSchemaVersionRequest, opts ...grpc.CallOption) (*SearchSchemaVersionResponse, error) {
	...
	err := c.cc.Invoke(ctx, SchemaVersionService_SearchSchemaVersion_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSchemaVersionServiceServer must be embedded to have
...
func (UnimplementedSchemaVersionServiceServer) testEmbeddedByValue()                              {}
...
func RegisterSchemaVersionServiceServer(s grpc.ServiceRegistrar, srv SchemaVersionServiceServer) {
	// If the following call pancis, it indicates UnimplementedSchemaVersionServiceServer was
