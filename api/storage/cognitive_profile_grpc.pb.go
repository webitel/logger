...
func (c *cognitiveProfileServiceClient) CreateCognitiveProfile(ctx context.Context, in *CreateCognitiveProfileRequest, opts ...grpc.CallOption) (*CognitiveProfile, error) {
	...
	err := c.cc.Invoke(ctx, CognitiveProfileService_CreateCognitiveProfile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cognitiveProfileServiceClient) SearchCognitiveProfile(ctx context.Context, in *SearchCognitiveProfileRequest, opts ...grpc.CallOption) (*ListCognitiveProfile, error) {
	...
	err := c.cc.Invoke(ctx, CognitiveProfileService_SearchCognitiveProfile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cognitiveProfileServiceClient) ReadCognitiveProfile(ctx context.Context, in *ReadCognitiveProfileRequest, opts ...grpc.CallOption) (*CognitiveProfile, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CognitiveProfile)
	err := c.cc.Invoke(ctx, CognitiveProfileService_ReadCognitiveProfile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cognitiveProfileServiceClient) UpdateCognitiveProfile(ctx context.Context, in *UpdateCognitiveProfileRequest, opts ...grpc.CallOption) (*CognitiveProfile, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CognitiveProfile)
	err := c.cc.Invoke(ctx, CognitiveProfileService_UpdateCognitiveProfile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cognitiveProfileServiceClient) PatchCognitiveProfile(ctx context.Context, in *PatchCognitiveProfileRequest, opts ...grpc.CallOption) (*CognitiveProfile, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CognitiveProfile)
	err := c.cc.Invoke(ctx, CognitiveProfileService_PatchCognitiveProfile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cognitiveProfileServiceClient) DeleteCognitiveProfile(ctx context.Context, in *DeleteCognitiveProfileRequest, opts ...grpc.CallOption) (*CognitiveProfile, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CognitiveProfile)
	err := c.cc.Invoke(ctx, CognitiveProfileService_DeleteCognitiveProfile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cognitiveProfileServiceClient) SearchCognitiveProfileVoices(ctx context.Context, in *SearchCognitiveProfileVoicesRequest, opts ...grpc.CallOption) (*ListCognitiveProfileVoices, error) {
	...
	err := c.cc.Invoke(ctx, CognitiveProfileService_SearchCognitiveProfileVoices_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedCognitiveProfileServiceServer must be embedded to have
...
func (UnimplementedCognitiveProfileServiceServer) testEmbeddedByValue() {}
...
func RegisterCognitiveProfileServiceServer(s grpc.ServiceRegistrar, srv CognitiveProfileServiceServer) {
	// If the following call pancis, it indicates UnimplementedCognitiveProfileServiceServer was
