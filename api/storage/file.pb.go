...
func (x *DeleteScreenRecordingsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *DeleteScreenRecordingsRequest) GetId() []int64 {
	if x != nil {
		return x.Id
	}
	return nil
...
type DeleteScreenRecordingsByAgentRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *DeleteScreenRecordingsByAgentRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *DeleteScreenRecordingsByAgentRequest) GetId() []int64 {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *SearchScreenRecordingsRequest) GetChannel() UploadFileChannel {
	if x != nil {
		return x.Channel
	}
...
type SearchScreenRecordingsByAgentRequest struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	AgentId        int64                  `protobuf:"varint,1,opt,name=agent_id,json=agentId,proto3" json:"agent_id,omitempty"`
	Page           int32                  `protobuf:"varint,2,opt,name=page,proto3" json:"page,omitempty"`
	Size           int32                  `protobuf:"varint,3,opt,name=size,proto3" json:"size,omitempty"`
...
func (x *SearchScreenRecordingsByAgentRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *SearchScreenRecordingsByAgentRequest) GetPage() int32 {
	if x != nil {
		return x.Page
	}
	return 0
...
func (x *SearchScreenRecordingsByAgentRequest) GetSize() int32 {
	if x != nil {
		return x.Size
	}
	return 0
...
func (x *SearchScreenRecordingsByAgentRequest) GetQ() string {
	if x != nil {
		return x.Q
	}
	return ""
...
func (x *SearchScreenRecordingsByAgentRequest) GetSort() string {
	if x != nil {
		return x.Sort
	}
	return ""
...
func (x *SearchScreenRecordingsByAgentRequest) GetFields() []string {
	if x != nil {
		return x.Fields
	}
	return nil
...
func (x *SearchScreenRecordingsByAgentRequest) GetId() []int64 {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *SearchScreenRecordingsByAgentRequest) GetUploadedAt() *engine.FilterBetween {
	if x != nil {
		return x.UploadedAt
	}
	return nil
...
func (x *SearchScreenRecordingsByAgentRequest) GetReferenceId() []string {
	if x != nil {
		return x.ReferenceId
	}
	return nil
...
func (x *SearchScreenRecordingsByAgentRequest) GetRetentionUntil() *engine.FilterBetween {
	if x != nil {
		return x.RetentionUntil
	}
	return nil
...
func (x *SearchScreenRecordingsByAgentRequest) GetChannel() UploadFileChannel {
	if x != nil {
		return x.Channel
	}
	return UploadFileChannel_UnknownChannel
...
type SafeUploadFileResponse_Metadata struct {
	...
	Malware       *FileMalwareScan       `protobuf:"bytes,11,opt,name=malware,proto3" json:"malware,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SafeUploadFileResponse_Metadata) GetMalware() *FileMalwareScan {
	if x != nil {
		return x.Malware
	}
	return nil
...
const file_file_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"file.proto\x12\astorage\x1a\vconst.proto\x1a\x1cgoogle/api/annotations.proto\".\n" +
	"\x1cDeleteQuarantineFilesRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x03(\x03R\x02id\"%\n" +
	"\x13RestoreFilesRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x03(\x03R\x02id\"\x16\n" +
	"\x14RestoreFilesResponse\"H\n" +
	"\x1dDeleteScreenRecordingsRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x03R\x06userId\x12\x0e\n" +
	"\x02id\x18\x02 \x03(\x03R\x02id\"Q\n" +
	"$DeleteScreenRecordingsByAgentRequest\x12\x19\n" +
	"\bagent_id\x18\x01 \x01(\x03R\aagentId\x12\x0e\n" +
	"\x02id\x18\x02 \x03(\x03R\x02id\"\xfb\x02\n" +
	"\x1dSearchScreenRecordingsRequest\x12\x17\n" +
	...
	"\x02id\x18\a \x03(\x03R\x02id\x126\n" +
	"\vuploaded_at\x18\b \x01(\v2\x15.engine.FilterBetweenR\n" +
	"uploadedAt\x12!\n" +
	"\freference_id\x18\t \x03(\tR\vreferenceId\x12>\n" +
	"\x0fretention_until\x18\n" +
	" \x01(\v2\x15.engine.FilterBetweenR\x0eretentionUntil\x124\n" +
	"\achannel\x18\v \x01(\x0e2\x1a.storage.UploadFileChannelR\achannel\"\x84\x03\n" +
	"$SearchScreenRecordingsByAgentRequest\x12\x19\n" +
	...
	"\x0fretention_until\x18\n" +
	" \x01(\v2\x15.engine.FilterBetweenR\x0eretentionUntil\x124\n" +
	"\achannel\x18\v \x01(\x0e2\x1a.storage.UploadFileChannelR\achannel\"U\n" +
	...
	"\x05scale\x18\x03 \x01(\tR\x05scale\"a\n" +
	"\x0fFileMalwareScan\x12\x14\n" +
	...
	"\x12generate_thumbnail\x18\a \x01(\bR\x11generateThumbnail\"\xac\x02\n" +
	...
	"\x06server\x18\t \x01(\tR\x06server\x122\n" +
	"\amalware\x18\n" +
	" \x01(\v2\x18.storage.FileMalwareScanR\amalware\"\xd2\x03\n" +
	"\x11UploadFileRequest\x12A\n" +
	"\bmetadata\x18\x01 \x01(\v2#.storage.UploadFileRequest.MetadataH\x00R\bmetadata\x12\x16\n" +
	"\x05chunk\x18\x02 \x01(\fH\x00R\x05chunk\x1a\xd9\x02\n" +
	"\bMetadata\x12\x1b\n" +
	"\tdomain_id\x18\x01 \x01(\x03R\bdomainId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x1b\n" +
	"\tmime_type\x18\x03 \x01(\tR\bmimeType\x12\x12\n" +
	...
	"\x12generate_thumbnail\x18\b \x01(\bR\x11generateThumbnail\x12\x1f\n" +
	"\vuploaded_by\x18\t \x01(\x03R\n" +
	"uploadedBy\x12\x1d\n" +
	"\n" +
	"created_at\x18\n" +
	" \x01(\x03R\tcreatedAtB\x06\n" +
	"\x04data\"6\n" +
	...
	"\bprogress\x18\x03 \x01(\v2(.storage.SafeUploadFileResponse.ProgressH\x00R\bprogress\x1a\xe2\x02\n" +
	"\bMetadata\x12\x17\n" +
	...
	"\tthumbnail\x18\n" +
	" \x01(\v2\x12.storage.ThumbnailR\tthumbnail\x122\n" +
	"\amalware\x18\v \x01(\v2\x18.storage.FileMalwareScanR\amalware\x1a7\n" +
	"\x04Part\x12\x1b\n" +
	...
	"\x06server\x18\x05 \x01(\tR\x06server\x12\x1c\n" +
	"\tsha256sum\x18\x06 \x01(\tR\tsha256sum\x120\n" +
	"\tthumbnail\x18\a \x01(\v2\x12.storage.ThumbnailR\tthumbnail\x122\n" +
	"\amalware\x18\b \x01(\v2\x18.storage.FileMalwareScanR\amalware*3\n" +
	"\x10UploadStatusCode\x12\v\n" +
	"\aUnknown\x10\x00\x12\x06\n" +
	"\x02Ok\x10\x01\x12\n" +
	"\n" +
	"\x06Failed\x10\x02*\xd9\x01\n" +
	...
	"\fCasesChannel\x10\a\x12\x15\n" +
	"\x11ScreenshotChannel\x10\b\x12\x18\n" +
	"\x14ScreenSharingChannel\x10\t2\xdc\v\n" +
	"\vFileService\x12I\n" +
	"\n" +
	...
	"\vDeleteFiles\x12\x1b.storage.DeleteFilesRequest\x1a\x1c.storage.DeleteFilesResponse\"\x18\x82\xd3\xe4\x93\x02\x12:\x01**\r/storage/file\x12m\n" +
	"\fRestoreFiles\x12\x1c.storage.RestoreFilesRequest\x1a\x1d.storage.RestoreFilesResponse\" \x82\xd3\xe4\x93\x02\x1a:\x01*2\x15/storage/file/restore\x12\x81\x01\n" +
	"\x15DeleteQuarantineFiles\x12%.storage.DeleteQuarantineFilesRequest\x1a\x1c.storage.DeleteFilesResponse\"#\x82\xd3\xe4\x93\x02\x1d:\x01**\x18/storage/file/quarantine\x12T\n" +
	"\vSearchFiles\x12\x1b.storage.SearchFilesRequest\x1a\x11.storage.ListFile\"\x15\x82\xd3\xe4\x93\x02\x0f\x12\r/storage/file\x12u\n" +
	"\x16SearchScreenRecordings\x12&.storage.SearchScreenRecordingsRequest\x1a\x11.storage.ListFile\" \x82\xd3\xe4\x93\x02\x1a\x12\x18/storage/users/{user_id}\x12\x84\x01\n" +
	"\x1dSearchScreenRecordingsByAgent\x12-.storage.SearchScreenRecordingsByAgentRequest\x1a\x11.storage.ListFile\"!\x82\xd3\xe4\x93\x02\x1b\x12\x19/storage/agent/{agent_id}\x12\x88\x01\n" +
	"\x16DeleteScreenRecordings\x12&.storage.DeleteScreenRecordingsRequest\x1a\x1c.storage.DeleteFilesResponse\"(\x82\xd3\xe4\x93\x02\":\x01**\x1d/storage/users/{user_id}/{id}\x12\x97\x01\n" +
	"\x1dDeleteScreenRecordingsByAgent\x12-.storage.DeleteScreenRecordingsByAgentRequest\x1a\x1c.storage.DeleteFilesResponse\")\x82\xd3\xe4\x93\x02#:\x01**\x1e/storage/agent/{agent_id}/{id}Bw\n" +
