...
const file_user_helper_proto_rawDesc = "" +
	"\n" +
	"\x11user_helper.proto\x12\x06engine\x1a\x1cgoogle/api/annotations.proto\"\x94\x01\n" +
	"\x17OpenedWebSocketsRequest\x12\x12\n" +
	...
	"\auser_id\x18\a \x03(\x03R\x06userId\"\xfb\x01\n" +
	"\x0fOpenedWebSocket\x12\x0e\n" +
	...
	"\x10application_name\x18\x06 \x01(\tR\x0fapplicationName\x12\x1a\n" +
	"\bduration\x18\a \x01(\x03R\bduration\x12\x12\n" +
	"\x04pong\x18\b \x01(\x03R\x04pong\x12\x10\n" +
	"\x03ver\x18\t \x01(\tR\x03ver\"X\n" +
	"\x13ListOpenedWebSocket\x12\x12\n" +
	"\x04next\x18\x01 \x01(\bR\x04next\x12-\n" +
	"\x05items\x18\x02 \x03(\v2\x17.engine.OpenedWebSocketR\x05items\"8\n" +
	...
	"\x17ActivityWorkspaceWidget\x12&.engine.ActivityWorkspaceWidgetRequest\x1a'.engine.ActivityWorkspaceWidgetResponse\"#\x82\xd3\xe4\x93\x02\x1d\x12\x1b/user/widget/activity/today\x12t\n" +
	"\x10OpenedWebSockets\x12\x1f.engine.OpenedWebSocketsRequest\x1a\x1b.engine.ListOpenedWebSocket\"\"\x82\xd3\xe4\x93\x02\x1c\x12\x1a/user/{user_id}/websocketsB\"Z github.com/webitel/protos/engineb\x06proto3"
...
func file_user_helper_proto_init() {
	...
	file_user_helper_proto_msgTypes[6].OneofWrappers = []any{
