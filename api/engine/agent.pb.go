...
const file_agent_proto_rawDesc = "" +
	...
	"\x04time\x18\x02 \x01(\v2\x15.engine.FilterBetweenR\x04time\"\xa4\x05\n" +
	...
	"\x15AgentSetStateResponse\"\xc2\x06\n" +
	...
	"pauseCause\x12\x1c\n" +
	"\toccupancy\x18\x19 \x01(\x02R\toccupancy\"`\n" +
	...
	"\x04next\x18\x01 \x01(\bR\x04next\x12)\n" +
	"\x05items\x18\x02 \x03(\v2\x13.engine.AgentInTeamR\x05items\"\x9b\x04\n" +
	...
	"\n" +
	"task_count\x18\x0e \x01(\rR\ttaskCount\"\xf6\x03\n" +
	...
	"\x06region\x18\v \x01(\v2\x0e.engine.LookupR\x06region\x12(\n" +
	"\aauditor\x18\f \x03(\v2\x0e.engine.LookupR\aauditor\x12#\n" +
	"\ris_supervisor\x18\r \x01(\bR\fisSupervisor\"?\n" +
	...
	"\n" +
	"task_count\x18\r \x01(\rR\ttaskCount\"\xa1\x01\n" +
	"\n" +
	"SkillAgent\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12$\n" +
	"\x05skill\x18\x02 \x01(\v2\x0e.engine.LookupR\x05skill\x12$\n" +
	"\x05agent\x18\x03 \x01(\v2\x0e.engine.LookupR\x05agent\x127\n" +
	"\bcapacity\x18\x04 \x01(\v2\x1b.google.protobuf.Int32ValueR\bcapacity\"\xac\x01\n" +
	...
	"\tdomain_id\x18\x06 \x01(\x03R\bdomainId\"u\n" +
	...
	"\atimeout\x18\x04 \x01(\x03R\atimeout\"\xea\x05\n" +
	"\x05Agent\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\"\n" +
	...
	"\n" +
	"task_count\x18\x14 \x01(\rR\ttaskCount\"D\n" +
	"\tListAgent\x12\x12\n" +
	"\x04next\x18\x01 \x01(\bR\x04next\x12#\n" +
