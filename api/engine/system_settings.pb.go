...
const file_system_settings_proto_rawDesc = "" +
	...
	"\x05items\x18\x02 \x03(\v2\x15.engine.SystemSettingR\x05items*\xaf\a\n" +
	...
	"\x18labels_to_limit_contacts\x10\x17\x12\x1c\n" +
	"\x18autolink_mail_to_contact\x10\x18\x12\"\n" +
	"\x1enew_message_sound_notification\x10\x19\x12\x1f\n" +
	"\x1bnew_chat_sound_notification\x10\x1a\x12\x17\n" +
	"\x13screenshot_interval\x10\x1b\x12\x18\n" +
	"\x14password_expiry_days\x10\x1c\x12\x17\n" +
	"\x13password_min_length\x10\x1d\x12\x17\n" +
	"\x13password_categories\x10\x1e\x12\x1e\n" +
	"\x1apassword_contains_username\x10\x1f\x12\x19\n" +
	"\x15password_warning_days\x10 2\x9e\x06\n" +
