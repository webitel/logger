...
func (c *webHookServiceClient) SearchWebHook(ctx context.Context, in *SearchWebHookRequest, opts ...grpc.CallOption) (*ListWebHook, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListWebHook)
	err := c.cc.Invoke(ctx, WebHookService_SearchWebHook_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *webHookServiceClient) ReadWebHook(ctx context.Context, in *ReadWebHookRequest, opts ...grpc.CallOption) (*WebHook, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WebHook)
	err := c.cc.Invoke(ctx, WebHookService_ReadWebHook_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *webHookServiceClient) PatchWebHook(ctx context.Context, in *PatchWebHookRequest, opts ...grpc.CallOption) (*WebHook, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WebHook)
	err := c.cc.Invoke(ctx, WebHookService_PatchWebHook_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
