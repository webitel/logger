...
func (c *loggerServiceClient) SearchLogByUserId(ctx context.Context, in *SearchLogByUserIdRequest, opts ...grpc.CallOption) (*Logs, error) {
	...
	out := new(Logs)
	err := c.cc.Invoke(ctx, LoggerService_SearchLogByUserId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *loggerServiceClient) SearchLogByConfigId(ctx context.Context, in *SearchLogByConfigIdRequest, opts ...grpc.CallOption) (*Logs, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Logs)
	err := c.cc.Invoke(ctx, LoggerService_SearchLogByConfigId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *loggerServiceClient) SearchLogByRecordId(ctx context.Context, in *SearchLogByRecordIdRequest, opts ...grpc.CallOption) (*Logs, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Logs)
	err := c.cc.Invoke(ctx, LoggerService_SearchLogByRecordId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *loggerServiceClient) DeleteConfigLogs(ctx context.Context, in *DeleteConfigLogsRequest, opts ...grpc.CallOption) (*DeleteConfigLogsResponse, error) {
	...
	err := c.cc.Invoke(ctx, LoggerService_DeleteConfigLogs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
