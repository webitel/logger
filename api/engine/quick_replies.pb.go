...
const file_quick_replies_proto_rawDesc = "" +
	"\n" +
	"\x13quick_replies.proto\x12\x06engine\x1a\x1cgoogle/api/annotations.proto\x1a\vconst.proto\"\xb9\x01\n" +
	"\x17CreateQuickReplyRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x12\n" +
	"\x04text\x18\x02 \x01(\tR\x04text\x12&\n" +
	"\x06queues\x18\x03 \x03(\v2\x0e.engine.LookupR\x06queues\x12$\n" +
	"\x05teams\x18\x04 \x03(\v2\x0e.engine.LookupR\x05teams\x12(\n" +
	"\aarticle\x18\x05 \x01(\v2\x0e.engine.LookupR\aarticle\"\xd8\x02\n" +
	"\n" +
	"QuickReply\x12\x0e\n" +
	...
	"\x05teams\x18\b \x03(\v2\x0e.engine.LookupR\x05teams\x12(\n" +
	"\aarticle\x18\t \x01(\v2\x0e.engine.LookupR\aarticle\x12&\n" +
	"\x06queues\x18\n" +
	" \x03(\v2\x0e.engine.LookupR\x06queues\"\xa3\x01\n" +
	"\x19SearchQuickRepliesRequest\x12\x12\n" +
	...
	"\x02id\x18\x06 \x03(\rR\x02id\x12\x14\n" +
	"\x05queue\x18\a \x03(\rR\x05queue\"P\n" +
	"\x10ListQuickReplies\x12\x12\n" +
	"\x04next\x18\x01 \x01(\bR\x04next\x12(\n" +
	"\x05items\x18\x02 \x03(\v2\x12.engine.QuickReplyR\x05items\"'\n" +
	"\x15ReadQuickReplyRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\"\xe0\x01\n" +
	"\x16PatchQuickReplyRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\x12\x16\n" +
	"\x06fields\x18\x02 \x03(\tR\x06fields\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x12\n" +
	"\x04text\x18\x04 \x01(\tR\x04text\x12$\n" +
	"\x05teams\x18\x05 \x03(\v2\x0e.engine.LookupR\x05teams\x12(\n" +
	"\aarticle\x18\x06 \x01(\v2\x0e.engine.LookupR\aarticle\x12&\n" +
	"\x06queues\x18\a \x03(\v2\x0e.engine.LookupR\x06queues\"\xc9\x01\n" +
	"\x17UpdateQuickReplyRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x12\n" +
	"\x04text\x18\x03 \x01(\tR\x04text\x12$\n" +
	"\x05teams\x18\x04 \x03(\v2\x0e.engine.LookupR\x05teams\x12(\n" +
	"\aarticle\x18\x05 \x01(\v2\x0e.engine.LookupR\aarticle\x12&\n" +
	"\x06queues\x18\x06 \x03(\v2\x0e.engine.LookupR\x06queues\")\n" +
	"\x17DeleteQuickReplyRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id2\xc4\x05\n" +
	"\x13QuickRepliesService\x12n\n" +
	"\x10CreateQuickReply\x12\x1f.engine.CreateQuickReplyRequest\x1a\x12.engine.QuickReply\"%\x82\xd3\xe4\x93\x02\x1f:\x01*\"\x1a/call_center/quick_replies\x12u\n" +
	"\x12SearchQuickReplies\x12!.engine.SearchQuickRepliesRequest\x1a\x18.engine.ListQuickReplies\"\"\x82\xd3\xe4\x93\x02\x1c\x12\x1a/call_center/quick_replies\x12l\n" +
	"\x0eReadQuickReply\x12\x1d.engine.ReadQuickReplyRequest\x1a\x12.engine.QuickReply\"'\x82\xd3\xe4\x93\x02!\x12\x1f/call_center/quick_replies/{id}\x12q\n" +
	"\x0fPatchQuickReply\x12\x1e.engine.PatchQuickReplyRequest\x1a\x12.engine.QuickReply\"*\x82\xd3\xe4\x93\x02$:\x01*2\x1f/call_center/quick_replies/{id}\x12s\n" +
	"\x10UpdateQuickReply\x12\x1f.engine.UpdateQuickReplyRequest\x1a\x12.engine.QuickReply\"*\x82\xd3\xe4\x93\x02$:\x01*\x1a\x1f/call_center/quick_replies/{id}\x12p\n" +
	"\x10DeleteQuickReply\x12\x1f.engine.DeleteQuickReplyRequest\x1a\x12.engine.QuickReply\"'\x82\xd3\xe4\x93\x02!*\x1f/call_center/quick_replies/{id}B\"Z github.com/webitel/protos/engineb\x06proto3"
