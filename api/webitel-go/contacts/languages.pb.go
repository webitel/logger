...
const file_contacts_languages_proto_rawDesc = "" +
	"\n" +
	"\x18contacts/languages.proto\x12\x10webitel.contacts\x1a\x15contacts/fields.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\x8b\x01\n" +
	...
	"\x06script\x18\x06 \x01(\tR\x06script\"\x88\x03\n" +
	"\bLanguage\x12\x0e\n" +
	...
	"\aprimary\x18\n" +
	" \x01(\bR\aprimary\x12\x10\n" +
	"\x03tag\x18\v \x01(\tR\x03tag\x12\x12\n" +
	"\x04code\x18\f \x01(\tR\x04code\x12\x12\n" +
	"\x04lang\x18\r \x01(\tR\x04lang\x12\x12\n" +
	"\x04name\x18\x0e \x01(\tR\x04name\x12\x16\n" +
	"\x06region\x18\x0f \x01(\tR\x06region\x12\x16\n" +
	"\x06script\x18\x10 \x01(\tR\x06script\"\x8a\x01\n" +
	"\rInputLanguage\x12!\n" +
	"\x04etag\x18\x01 \x01(\tB\r\x92A\n" +
	"\xca>\a\xfa\x02\x04etagR\x04etag\x12\x18\n" +
	"\aprimary\x18\n" +
	" \x01(\bR\aprimary\x12\x10\n" +
	"\x03tag\x18\v \x01(\tR\x03tag:*\x92A'\n" +
	"\a\xd2\x01\x04etag2\x1c{\"primary\":false,\"tag\":\"uk\"}\"\xc6\x03\n" +
	"\fLanguageList\x12.\n" +
	"\x04data\x18\x01 \x03(\v2\x1a.webitel.contacts.LanguageR\x04data\x12\x12\n" +
	"\x04page\x18\x02 \x01(\x05R\x04page\x12\x12\n" +
	"\x04next\x18\x03 \x01(\bR\x04next:\xdd\x02\x92A\xd9\x022\xd6\x02{\"data\":[{\"id\":\"7\",\"ver\":\"3\",\"etag\":\"FqaTCDLbhpaoUreL\",\"created_at\":\"1680268507698\",\"created_by\":{\"id\":\"34\",\"name\":\"John Doe\"},\"updated_at\":\"1680516785357\",\"updated_by\":{\"name\":\"Jane Lee (deleted)\"},\"primary\":true,\"tag\":\"uk-UA\",\"code\":\"uk\",\"lang\":\"Ukrainian\",\"name\":\"українська\",\"region\":\"UA\",\"script\":\"Cyrl\"}],\"page\":1,\"next\":true}\"\xb3\x02\n" +
	"\x16SearchLanguagesRequest\x12\x12\n" +
	"\x04page\x18\x02 \x01(\x05R\x04page\x12\x12\n" +
	...
	"\aprimary\x18\b \x01(\v2\x1a.google.protobuf.BoolValueR\aprimary\x12\x12\n" +
	"\x04code\x18\n" +
	" \x01(\tR\x04code\x12\x12\n" +
	"\x04lang\x18\v \x01(\tR\x04lang\x12\x12\n" +
	"\x04name\x18\f \x01(\tR\x04name\x12\x16\n" +
	"\x06region\x18\r \x01(\tR\x06region\"\xa6\x01\n" +
	"\x16CreateLanguagesRequest\x12\x16\n" +
	"\x06fields\x18\x01 \x03(\tR\x06fields\x12\x1d\n" +
	"\n" +
	"contact_id\x18\x02 \x01(\tR\tcontactId\x12U\n" +
	"\x05input\x18\x03 \x03(\v2\x1f.webitel.contacts.InputLanguageB\x1e\x92A\x1bJ\x13[\"uk\",\"en-GB\",\"pl\"]\xa8\x01\x01\xb0\x01\x01R\x05input\"\xa6\x01\n" +
	"\x16UpdateLanguagesRequest\x12\x16\n" +
	"\x06fields\x18\x01 \x03(\tR\x06fields\x12\x1d\n" +
	"\n" +
	"contact_id\x18\x02 \x01(\tR\tcontactId\x12U\n" +
	"\x05input\x18\x03 \x03(\v2\x1f.webitel.contacts.InputLanguageB\x1e\x92A\x1bJ\x13[\"uk\",\"en-GB\",\"pl\"]\xa8\x01\x01\xb0\x01\x01R\x05input\"\xc0\x01\n" +
	"\x15UpdateLanguageRequest\x12\x16\n" +
	"\x06fields\x18\x01 \x03(\tR\x06fields\x12\x1d\n" +
	"\n" +
	"contact_id\x18\x02 \x01(\tR\tcontactId\x12U\n" +
	"\x05input\x18\x03 \x01(\v2\x1f.webitel.contacts.InputLanguageB\x1e\x92A\x1bJ\x13[\"uk\",\"en-GB\",\"pl\"]\xa8\x01\x01\xb0\x01\x01R\x05input:\x19\x92A\x16\n" +
	"\x14\xd2\x01\n" +
	"contact_id\xd2\x01\x04data\"\x89\x01\n" +
	"\x16DeleteLanguagesRequest\x12\x16\n" +
	"\x06fields\x18\x01 \x03(\tR\x06fields\x12\x1d\n" +
	"\n" +
	"contact_id\x18\x02 \x01(\tR\tcontactId\x12\x1d\n" +
	"\x04etag\x18\x03 \x03(\tB\t\x92A\x06\xa8\x01\x01\xb0\x01\x01R\x04etag:\x19\x92A\x16\n" +
	"\x14\xd2\x01\n" +
	"contact_id\xd2\x01\x04etag\"\x82\x01\n" +
	"\x15DeleteLanguageRequest\x12\x16\n" +
	"\x06fields\x18\x01 \x03(\tR\x06fields\x12\x1d\n" +
	"\n" +
	"contact_id\x18\x02 \x01(\tR\tcontactId\x12\x17\n" +
	"\x04etag\x18\x03 \x01(\tB\x03\x92A\x00R\x04etag:\x19\x92A\x16\n" +
	"\x14\xd2\x01\n" +
	"contact_id\xd2\x01\x04etag2\xac\a\n" +
	"\tLanguages\x12\x89\x01\n" +
	"\x13GetContactLanguages\x12(.webitel.contacts.SearchLanguagesRequest\x1a\x1e.webitel.contacts.LanguageList\"(\x82\xd3\xe4\x93\x02\"\x12 /contacts/{contact_id}/languages\x12\x90\x01\n" +
	"\x13AddContactLanguages\x12(.webitel.contacts.CreateLanguagesRequest\x1a\x1e.webitel.contacts.LanguageList\"/\x82\xd3\xe4\x93\x02):\x05input\" /contacts/{contact_id}/languages\x12\x90\x01\n" +
	"\x13SetContactLanguages\x12(.webitel.contacts.UpdateLanguagesRequest\x1a\x1e.webitel.contacts.LanguageList\"/\x82\xd3\xe4\x93\x02):\x05input\x1a /contacts/{contact_id}/languages\x12\xd3\x01\n" +
	"\x12SetContactLanguage\x12'.webitel.contacts.UpdateLanguageRequest\x1a\x1e.webitel.contacts.LanguageList\"t\x82\xd3\xe4\x93\x02n:\x05inputZ6:\x05input2-/contacts/{contact_id}/languages/{input.etag}\x1a-/contacts/{contact_id}/languages/{input.etag}\x12\x89\x01\n" +
	"\x13DelContactLanguages\x12(.webitel.contacts.DeleteLanguagesRequest\x1a\x1e.webitel.contacts.LanguageList\"(\x82\xd3\xe4\x93\x02\"* /contacts/{contact_id}/languages\x12\x8a\x01\n" +
	"\x12DelContactLanguage\x12'.webitel.contacts.DeleteLanguageRequest\x1a\x1a.webitel.contacts.Language\"/\x82\xd3\xe4\x93\x02)*'/contacts/{contact_id}/languages/{etag}B\xa9\x01\n" +
	"\x14com.webitel.contactsB\x0eLanguagesProtoP\x01Z webitel.go/api/contacts;contacts\xa2\x02\x03WCX\xaa\x02\x10Webitel.Contacts\xca\x02\x10Webitel\\Contacts\xe2\x02\x1cWebitel\\Contacts\\GPBMetadata\xea\x02\x11Webitel::Contactsb\x06proto3"
