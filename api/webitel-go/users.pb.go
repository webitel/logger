...
type User struct {
	...
	ForcePasswordChange bool `protobuf:"varint,27,opt,name=force_password_change,json=forcePasswordChange,proto3" json:"force_password_change,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *User) GetForcePasswordChange() bool {
	if x != nil {
...
type UpdatePasswordRequest struct {
	...
	Username        string                 `protobuf:"bytes,5,opt,name=username,proto3" json:"username,omitempty"`                                      // Username (when password expired)
	Domain          string                 `protobuf:"bytes,6,opt,name=domain,proto3" json:"domain,omitempty"`                                          // Domain name required for user lookup when password expired
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
const file_users_proto_rawDesc = "" +
	...
	"\x04name\x18\x02 \x01(\tR\x04name\"\xa8\a\n" +
	"\x04User\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x12\n" +
	...
	"\tchat_name\x18\x1a \x01(\tR\bchatName\x122\n" +
	"\x15force_password_change\x18\x1b \x01(\bR\x13forcePasswordChange\x1a:\n" +
	...
	"\vSearchUsers\x12\x17.api.SearchUsersRequest\x1a\x18.api.SearchUsersResponse\"\"\x82\xd3\xe4\x93\x02\x1cZ\x12:\x01*\"\r/users/search\x12\x06/users\x12e\n" +
	"\x0eUpdatePassword\x12\x1a.api.UpdatePasswordRequest\x1a\x1b.api.UpdatePasswordResponse\"\x1a\x82\xd3\xe4\x93\x02\x14:\x01*2\x0f/users/password\x12\\\n" +
	"\n" +
...
var file_users_proto_depIdxs = []int32{
	...
	12, // 25: api.Users.UpdatePassword:input_type -> api.UpdatePasswordRequest
	14, // 26: api.Users.LogoutUser:input_type -> api.LogoutUserRequest
	5,  // 27: api.Users.ReadUser:output_type -> api.ReadUserResponse
	7,  // 28: api.Users.UpdateUser:output_type -> api.UpdateUserResponse
	9,  // 29: api.Users.DeleteUsers:output_type -> api.DeleteUsersResponse
	3,  // 30: api.Users.CreateUser:output_type -> api.CreateUserResponse
	11, // 31: api.Users.SearchUsers:output_type -> api.SearchUsersResponse
	13, // 32: api.Users.UpdatePassword:output_type -> api.UpdatePasswordResponse
	15, // 33: api.Users.LogoutUser:output_type -> api.LogoutUserResponse
