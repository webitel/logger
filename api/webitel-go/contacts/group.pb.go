...
type Group struct {
	...
	ContactsSize  int64     `protobuf:"varint,20,opt,name=contactsSize,proto3" json:"contactsSize,omitempty"`
...
func (x *Group) GetContactsSize() int64 {
	if x != nil {
...
const file_contacts_group_proto_rawDesc = "" +
	"\n" +
	"\x14contacts/group.proto\x12\x10webitel.contacts\x1a\x15contacts/fields.proto\x1a\x1ccontacts/dynamic_group.proto\x1a\x17contacts/contacts.proto\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x1bgoogle/api/visibility.proto\"\xef\x03\n" +
	"\x05Group\x12\x0e\n" +
	...
	"\fcontactsSize\x18\x14 \x01(\x03R\fcontactsSize\"b\n" +
	"\tGroupList\x12\x12\n" +
	...
	"\x92A\a\n" +
	"\x05\xd2\x01\x02id\"W\n" +
	"\x19AddContactsToGroupRequest\x12\x19\n" +
	...
	"\vDeleteGroup\x12$.webitel.contacts.DeleteGroupRequest\x1a\x17.webitel.contacts.Group\"0\x92A\x10\x12\x0eDelete a group\x82\xd3\xe4\x93\x02\x17*\x15/contacts/groups/{id}\x12\xa9\x01\n" +
	"\x12AddContactsToGroup\x12+.webitel.contacts.AddContactsToGroupRequest\x1a\x1d.webitel.contacts.ContactList\"G\x92A\x19\x12\x17Add contacts to a group\x82\xd3\xe4\x93\x02%\"#/contacts/groups/{group_id}/contact\x12\xb8\x01\n" +
