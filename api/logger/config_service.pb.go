...
const file_config_service_proto_rawDesc = "" +
	...
	"\rSystemObjects\x12$\n" +
	"\x05items\x18\x03 \x03(\v2\x0e.logger.LookupR\x05items\"\xa7\x01\n" +
	"\x18ReadSystemObjectsRequest\x12)\n" +
	"\x10include_existing\x18\x01 \x01(\bR\x0fincludeExisting\x12\x12\n" +
	...
	"\x06fields\x18\x06 \x03(\tR\x06fields\"\a\n" +
	"\x05Empty\"\x9e\x02\n" +
	"\x06Config\x12\x0e\n" +
