...
func (c *loggerServiceClient) GetByUserId(ctx context.Context, in *User, opts ...grpc.CallOption) (*Logs, error) {
	out := new(Logs)
	err := c.cc.Invoke(ctx, "/webitel_logger.LoggerService/GetByUserId", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *loggerServiceClient) GetByObjectId(ctx context.Context, in *Object, opts ...grpc.CallOption) (*Logs, error) {
	out := new(Logs)
	err := c.cc.Invoke(ctx, "/webitel_logger.LoggerService/GetByObjectId", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LoggerService_GetByUserId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/webitel_logger.LoggerService/GetByUserId",
	}
...
func _LoggerService_GetByObjectId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/webitel_logger.LoggerService/GetByObjectId",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
type ConfigServiceClient interface {
	...
	GetAll(ctx context.Context, in *Domain, opts ...grpc.CallOption) (*Configs, error)
}
...
func (c *configServiceClient) Update(ctx context.Context, in *Config, opts ...grpc.CallOption) (*Config, error) {
	out := new(Config)
	err := c.cc.Invoke(ctx, "/webitel_logger.ConfigService/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *configServiceClient) GetByObjectId(ctx context.Context, in *Object, opts ...grpc.CallOption) (*Config, error) {
	out := new(Config)
	err := c.cc.Invoke(ctx, "/webitel_logger.ConfigService/GetByObjectId", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *configServiceClient) GetAll(ctx context.Context, in *Domain, opts ...grpc.CallOption) (*Configs, error) {
	out := new(Configs)
	err := c.cc.Invoke(ctx, "/webitel_logger.ConfigService/GetAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ConfigServiceServer interface {
	...
	GetAll(context.Context, *Domain) (*Configs, error)
...
func (UnimplementedConfigServiceServer) GetAll(context.Context, *Domain) (*Configs, error) {
...
func _ConfigService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/webitel_logger.ConfigService/Update",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ConfigService_GetByObjectId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/webitel_logger.ConfigService/GetByObjectId",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ConfigService_GetAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/webitel_logger.ConfigService/GetAll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConfigServiceServer).GetAll(ctx, req.(*Domain))
	}
	return interceptor(ctx, in, info, handler)
}
